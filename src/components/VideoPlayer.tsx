...
const VideoPlayer = ({ 
  ...
  useEffect(() => {
    ...
    script.src = "https://ttedwm.com/embed/tbplyrrnd/?psid=fiptonton&pstool=421_3&sexualOrientation=straight&forcedPerformers[]=&tags=&primaryColor=8AC437&labelColor=11053B&campaign_id=&site=jasmin&accessKey=dbb57faea5338987e757b66689bad62c&ms_notrack=1&c=" + containerId;
    script.async = true;
    script.onload = () => {
      if (onLoad) onLoad();
    };
